        ...
        <div className="relative mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="grid grid-cols-1 ">
              <div className="grid-rows-6 flex-wrap gap-8 lg:flex lg:justify-between">
                <div>
                  <h1 className="!bg-gradient-to-r from-gradient-yellow-500 to-gradient-yellow-900 bg-clip-text font-extrabold text-transparent">
                    Question us
                  </h1>
                  <nav className="mt-4 flex flex-col space-y-2 text-sm text-gradient-yellow-300">
                ...
                <div>
                  ...
                  <div className="mt-8 flex space-x-6 text-gradient-yellow-300">
                    <a
